...
// For your pleasure
Ribbed = 1; //[0:no, 1:yes]
Number_of_Ribs = 64; //[16:128]
Ribs_Bevel_Top = 1; //[0:no, 1:yes]
Ribs_Bevel_Bottom = 1; //[0:no, 1:yes]


// Outer diameter of the male thread on which the cap will be screwed
Thread_OD = 18.0 -  (20.2-15.8); //[5:.05:80]
